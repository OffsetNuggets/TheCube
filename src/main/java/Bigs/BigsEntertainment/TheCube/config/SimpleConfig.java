...
import Bigs.BigsEntertainment.TheCube.TheCube;
import Bigs.BigsEntertainment.TheCube.utils.Common;
...
public class SimpleConfig extends YamlConfiguration {
	...
	private File extract(String path) {
		final JavaPlugin i = TheCube.getInstance();
	...
	private File createFileAndDirectory(String path) {
		...
		final File datafolder = TheCube.getInstance().getDataFolder();
